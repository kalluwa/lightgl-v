...
Matrix.prototype = {
  ...
  //
  // Transforms the Vector3 as a point with a w coordinate of 1. This
  ...
  //
  // Transforms the Vector3 as a Vector3 with a w coordinate of 0. This
...
//
// Returns a matrix that rotates by `a` degrees around the Vector3 `x, y, z`.
